...
func PrintHeaderAndUtilityMethods(w io.Writer, pkg string) error {
	...
	return doTemplate(w, data, `// Code generated by github.com/bdware/cbor-gen. DO NOT EDIT.
...
func (f Field) TypeName() string {
	if f.Type.PkgPath() == "github.com/bdware/cbor-gen" {
...
`)
	case "github.com/bdware/cbor-gen.Deferred":
		return doTemplate(w, f, `
	{
{{ if .Pointer }}
